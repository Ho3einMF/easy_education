"""
Django settings for easy_education_api project.
...
SECRET_KEY = 'django-insecure--r)39fwn0b3a8(ytyy!h&q1kqkxpzc7_dp6ajq)x5q^_@)ld=s'
...
ROOT_URLCONF = 'easy_education_api.urls'
...
WSGI_APPLICATION = 'easy_education_api.wsgi.application'
